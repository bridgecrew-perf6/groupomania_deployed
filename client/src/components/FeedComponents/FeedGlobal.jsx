  ...
  return (
    <div className="flex-wrap responsive:flex-col responsiveXS:pl-1 responsiveXS:justify-center responsiveXS:overflow-hidden ">
      <div>
        <Publish />
        <div>
          <p className="myFont uppercase m-2 center text-3xl underline decoration-secondary decoration-4 underline-offset-4 border-4 border-double rounded-2xl border-primary">Fil d'actualité</p>
        </div>
