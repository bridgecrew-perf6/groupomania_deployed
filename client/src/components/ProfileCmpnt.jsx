...
const ProfileCmpnt = () => {
  ...
  return (
    <section className="bg-grey box m-auto p-8 pb-0 radius20 responsiveSmall:p-1">
      <div className="flex">
        <p onClick={()=>home('/')}>          {/* retour vers le fil d'actualité*/}
          <FontAwesomeIcon
      ...
      <div className="center flex-col">
        <p className="myFont text-primary uppercase  ">Modifier ma photo</p>
        ...
        <p className="myFont text-primary uppercase ">Modifier le nom d'utilisateur</p>
        <form onSubmit={handleModify} className="center flex-col w-[50%]">
          <label htmlFor="modifyUsername" className=' w-[100%] mb-2 font-bold text-center '> Choisir un nouveau nom d'utilisateur:
          <input
          id='modifyUsername'
            maxLength={15}
          ...
          <button className="button myFont text-xl text-grey bg-primary hover:text-black w-[30%]">
            Enregistrer
          </button>
        </form>
        <div className="border text-secondary w-full"></div>
